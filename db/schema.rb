...
ActiveRecord::Schema.define(version: 20180904150000) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["restaurant_id", "post_id"], name: "index_comments_on_restaurant_id_and_post_id", using: :btree
  end
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.index ["restaurant_id"], name: "index_messages_on_restaurant_id", using: :btree
  end
